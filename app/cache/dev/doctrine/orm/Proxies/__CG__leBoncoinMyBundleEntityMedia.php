 ...
 */
class Media extends \le\Boncoin\MyBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'le\\Boncoin\\MyBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'le\\Boncoin\\MyBundle\\Entity\\Media' . "\0" . 'alt', '' . "\0" . 'le\\Boncoin\\MyBundle\\Entity\\Media' . "\0" . 'path'];
        }
